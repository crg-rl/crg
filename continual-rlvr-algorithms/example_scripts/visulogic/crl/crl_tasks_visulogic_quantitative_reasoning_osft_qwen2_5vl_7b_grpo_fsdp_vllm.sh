...
exp_name="${EXP_NAME:-qwen2_5vl_7b_crl_tasks_visulogic_quantitative_reasoning_osft_grpo_fsdp_vllm_${accel_label}}"
...
tasks="['Linear Quantity','Prime Quantity','Point Quantity','Counter Quantity']"
num_tasks=4
