...
exp_name="qwen3_4b_crl_tasks_algorithmic_ewc_grpo_fsdp_vllm_4_910b"
...
"$PYTHON_BIN" -m continual_rlvr_algorithms.train \
    ...
    -- \
    +task_runner_cls=continual_rlvr_algorithms.method.ewc.task_runner:EWCReasoningGymRunner \
