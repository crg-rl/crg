...
exp_name="qwen2_5vl_7b_crl_tasks_visulogic_positional_reasoning_grpo_fsdp_vllm"
...
data_root="${VISULOGIC_DATA_ROOT:-$workspace_code_root/data/visulogic/positional}"
...
# 500 total steps across 4 Figure-1 Positional subtypes => 125 steps / subtype.
steps_per_task=125
